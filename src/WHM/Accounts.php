...
use LightsLab\cPanelWHM\Entity\Account;
use LightsLab\cPanelWHM\Entity\Domain;
use LightsLab\cPanelWHM\Entity\DomainUser;
use LightsLab\cPanelWHM\Entity\SuspendedAccount;
use LightsLab\cPanelWHM\Exceptions\ClientExceptions;
use LightsLab\cPanelWHM\WHMClient;

/**
 * Class Accounts
 *
 * @package LightsLab\cPanelWHM\WHM
 */
class Accounts
{
    /**
     ...
     *       echo $e->getMessage();
     *   } catch (\LightsLab\cPanelWHM\Exceptions\ClientExceptions $e) {
     *       echo $e->getMessage();
     *   }
     *
